...
val list = 1 to 20                                //> list  : scala.collection.immutable.Range.Inclusive = Range 1 to 20
for (i <- list) {
	if (i % 3 == 0) {
		println(i)
	}                                         //> 3
...
val newList = list.filter(_ % 3 == 0)             //> newList  : scala.collection.immutable.IndexedSeq[Int] = Vector(3, 6, 9, 12,
                                                  //|  15, 18)
newList.foreach(println(_))                       //> 3
                                                  //| 6
                                                  //| 9
                                                  //| 12
                                                  //| 15
