object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(406); 
  ...
  def upper(s:String):String = {
  	s.toUpperCase()
  };System.out.println("""upper: (s: String)String""");$skip(33); val res$3 = 
  upper("This is a simple test");System.out.println("""res3: String = """ + $show(res$3));$skip(24); val res$4 = 
  upper("aNoTheR TeST");System.out.println("""res4: String = """ + $show(res$4));$skip(77); 
  
 	def transform(x: String, f : String => String) : String = {
 		f(x)
 	};System.out.println("""transform: (x: String, f: String => String)String""");$skip(62); val res$5 = 
 	
 	transform("This is a simple test", s => s.toUpperCase());System.out.println("""res5: String = """ + $show(res$5));$skip(50); val res$6 = 
 	transform("aNoTheR TeST", s => s.toUpperCase());System.out.println("""res6: String = """ + $show(res$6))}
