...
object LogParser {
  ...
  def main(args: Array[String]) {
    ...
    //Exercise modify script to track the most popular referrer
    //Exercise modify script to track the most popular user agent

    // Kick it off
    ssc.checkpoint("temp/checkpoint_log_parser/")
    ssc.start()
